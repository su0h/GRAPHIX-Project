...
public:
	...
	Shader(const char* vertPath, const char* fragPath) {
        ...
        try {
            ...
            // Print Vertex Shader code (for checking)
            std::cout << "----------------------------------------------------------------" << std::endl;
            std::cout << "Vertex Shader Content: " << std::endl;
            std::cout << "----------------------------------------------------------------" << std::endl;
            std::cout << vertexCodeStr << std::endl;
            std::cout << "----------------------------------------------------------------" << std::endl << std::endl;

            // Print Fragment Shader code (for checking)
            std::cout << "----------------------------------------------------------------" << std::endl;
            std::cout << "Fragment Shader Content: " << std::endl;
            std::cout << "----------------------------------------------------------------" << std::endl;
            std::cout << fragmentCodeStr << std::endl;
            std::cout << "----------------------------------------------------------------" << std::endl << std::endl;
        }
